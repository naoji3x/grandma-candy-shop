...
| ドキュメント | 略称 | 目的 | 主な内容 |
| --- | --- | --- | --- |
| [単体テスト / 仕様](../rules/uts-rules.md) | UTS | 単体テストとして確認する観点・条件を定義する（仕様） | 対象（クラス/関数/モジュール）、テスト範囲と対象外、観点（正常/異常/境界）、モック方針、テストデータ方針、カバレッジ目標、合格基準 |
| [単体テスト / 個別仕様](../rules/uts-detailed-rules.md) | UTS-D | 単体テスト仕様を対象（例：機能/モジュール/用語）ごとに分割して定義する（仕様） | 個別対象の範囲、観点、前提、テスト条件一覧、合格基準、関連する仕様ID/機能ID |
