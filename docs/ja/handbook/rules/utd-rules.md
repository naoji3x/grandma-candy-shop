...
| ----------- | ------- | ------ | ----------------------------------- | -------------------------------- | ---- |
| UTC-INV-001 | UT-I-01 | UC-01  | 在庫が十分（販売数量より大）        | 引当成功、減算後在庫が整合する   |      |
| UTC-INV-002 | UT-I-02 | UC-02  | 在庫が不足（販売数量より小）        | 引当不可、更新が行われない       |      |
| UTC-INV-003 | UT-I-03 | UC-03  | 入力不正（数量 0/負数、商品不正等） | 拒否（エラー）、更新が行われない |      |
